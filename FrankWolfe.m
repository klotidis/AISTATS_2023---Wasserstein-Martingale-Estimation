function [A_star, b_star, obj, res, var_cov_x, var_cov_w] = FrankWolfe(mu_x, cov_x, rho_x, mu_w, cov_w, rho_w, H, opts)
...
% Long description
    ...
    %%%%%%%%%%% Kyriakos Comment: var_cov_x is Cov(X,X) and var_cov_w is
    %%%%%%%%%%% Cov(W,W) under the worst-case distributions
